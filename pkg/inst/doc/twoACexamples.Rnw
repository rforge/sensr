...
<<example1-1, echo=t, results=verb>>=
library(sensR)
fit <- twoAC(c(2,2,6))
fit
@ 
...
with:
<<example2-fig, echo=t, results=verb, fig=t, include=f>>=
pr <- profile(fit)
plot(pr)
...
<<power-example, echo=t, results=verb>>=
...
<<power-example2, echo=t, results=verb>>=
twoACpwr(tau = 0.5, d.prime = 1, size = 20, d.prime0 = 0, alpha = 0.05, 
...
<<Example6-1, echo=t, results=verb>>=
...
<<example6-5, echo=t, results=verb>>=
...
<<example6-6, echo=t, results=verb>>=
...
<<example6-7, echo=t, results=verb>>=
...
<<example6-8, echo=t, fig=t, include=f, height=1.6>>=
...
@ 
<<example6-9, echo=t, fig=t, include=f, height=1.6>>=
par(mar = c(0, 2, 0, .5) + 0.5)
...
@
<<example6-10, echo=t, fig=t, include=f, height=2>>=
